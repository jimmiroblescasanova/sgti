...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Página principal","Aviso de Privacidad","1. RESPALDAR","2. RUCUPERAR LOS ARCHIVOS","3. RESTAURAR","Contacto","1.1. Ingreso al sistema","1.2. Abrir la empresa","1.3. Opción respaldar","1.4. Ventana respaldar empresa","2.1. Respaldo de BDD (BAK)","2.2. Respaldo del ADD","3.1. Identificar el respaldo","3.2. Colocar archivo de BDD","3.3. Colocar archivo ADD","3.4. Restaurar empresa"],
    DREX_NODE_LINKS: ["index.htm","aviso_de_privacidad.htm","respaldar.htm","rucuperar_los_archivos.htm","restaurar.htm","contacto.htm","ingreso_al_sistema.htm","abrir_la_empresa.htm","opcion_respaldar.htm","ventana_respaldar_empresa.htm","respaldo_de_bdd__bak_.htm","respaldo_del_add.htm","identificar_el_respaldo.htm","colocar_archivo_de_bdd.htm","colocar_archivo_add.htm","restaurar_empresa.htm"],
    DREX_NODE_CHILD_START: [1,6,6,10,12,16,16,16,16,16,16,16,16,16,16,16],
    DREX_NODE_CHILD_END: [6,6,10,12,16,16,16,16,16,16,16,16,16,16,16,16],
    DREX_MENU_TYPE: 1,
